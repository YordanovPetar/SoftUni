function printProductPrice(input) {
  ...
  if (town === "Sofia") {
    ...
    else if (product === "water") price = quantity * 0.80;
    else if (product === "beer") price = quantity * 1.20;
    else if (product === "sweets") price = quantity * 1.45;
    else if (product === "peanuts") price = quantity * 1.60;
    ...
    else if (product === "beer") price = quantity * 1.10;
...
printProductPrice(["sweets", "Sofia", "2.23"]);
